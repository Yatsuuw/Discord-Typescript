...
export default command(meta, async ({ interaction }) => {
    ...
    db.get('SELECT logChannelId FROM servers_settings WHERE guildId = ?', [guildId], async (err, row: ServersSettings) => {
        ...
        const sondageMessage = new EmbedBuilder()
            ...
            .setTimestamp()
            .setFooter({ text: `By yatsuuw @ Discord | Poll generated by ${interaction.user.username}.`, iconURL: 'https://media.discordapp.net/attachments/1280662607212314715/1280662682533363743/favicon.png?ex=66d8e591&is=66d79411&hm=9c74475031c6396856ac6574232d3946ede7a1495d8269fc0cbd470408aebf66&=&format=webp&quality=lossless&width=350&height=350' })
